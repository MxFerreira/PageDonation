...
<div class="container-fluid">
    <div class="my-5">
        ...
        <div class="py-3 text-center rounded mb-4" style="background-color: #08568f;">
            <h5 class="m-0 text-white" style="font-size:50px; 2rem; font-weight: bold;">Emergência</h5>
        </div>
			...
			<div class="row">
				<div class="col-md-6 col-12 align-middle d-flex">
					<div class="row mx-5">
						<div class="col-12">
							<p>
								 O setor de Emergência do Hospital Viamão é um ponto crítico de atendimento onde vidas 
                        são salvas diariamente. Nossa equipe médica está sempre pronta para agir, mas os desafios 
                        crescem a cada dia com a necessidade de materiais e insumos para o atendimento imediato.
                    </p>
                    <p>
                        Contamos com a solidariedade da comunidade para manter esse serviço vital funcionando. 
                        Sua doação faz a diferença! Ajude-nos a suprir as demandas do setor de emergência e garanta que 
                        possamos atender a todos com qualidade e agilidade.
							
						</div>
					</div>
				</div>
				<div class="col-md-6 col-12">
					<img src="../img/Setores/emerg.png" alt="#" width="50" height="70"
    ...
    <div class="col-md-10 col-12">
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
            ...
            <div class="col">
                <div class="card h-100 shadow-sm">
                    <div class="card-body text-center">
                        <h5 class="card-title text-danger">Materiais de primeiros socorros</h5>
                        <p class="card-text">Bandagens, gazes, ataduras e kits de curativos.</p>
                    </div>
                </div>
            </div>
            <!-- Item 2 -->
            <div class="col">
                <div class="card h-100 shadow-sm">
                    <div class="card-body text-center">
                        <h5 class="card-title text-danger">Medicamentos de uso emergencial</h5>
                        <p class="card-text">Adrenalina, antialérgicos, anti-hemorrágicos e outros.</p>
                    </div>
                </div>
            </div>
            <!-- Item 3 -->
            <div class="col">
                <div class="card h-100 shadow-sm">
                    <div class="card-body text-center">
                        <h5 class="card-title text-danger">Equipamentos de suporte à vida</h5>
                        <p class="card-text">Máscaras de oxigênio, tubos endotraqueais, e similares.</p>
                    </div>
                </div>
            </div>
            <!-- Item 4 -->
            <div class="col">
                <div class="card h-100 shadow-sm">
                    <div class="card-body text-center">
                        <h5 class="card-title text-danger">Materiais de imobilização</h5>
                        <p class="card-text">Colares cervicais, talas, e pranchas rígidas.</p>
                    </div>
                </div>
            </div>
            <!-- Item 5 -->
            <div class="col">
                <div class="card h-100 shadow-sm">
                    <div class="card-body text-center">
                        <h5 class="card-title text-danger">Soluções intravenosas</h5>
                        <p class="card-text">Soro fisiológico, soro glicosado e outros fluidos.</p>
                    </div>
                </div>
            </div>
            <!-- Item 6 -->
            <div class="col">
                <div class="card h-100 shadow-sm">
                    <div class="card-body text-center">
                        <h5 class="card-title text-danger">EPIs para a equipe</h5>
                        <p class="card-text">Luvas, máscaras, aventais e protetores faciais.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <h6 class="text-white text-center mb-4" style="font-size:25px; font-weight: bold;">
            Sua doação é essencial para salvar vidas no setor de Emergência. 
            Contribua e faça parte desta corrente de solidariedade!
        </h6>
    </div>
</div>
        ...
        <div class="row justify-content-center mt-5">
            ...
            <div class="col-md-4 col-sm-6 col-12 text-center mb-4">
                <a href="https://www.fornecedor2.com.br" target="_blank">
                    <img src="../img/Entidades/Logo Fornecedores Emergencia/02.jpg" alt="Fornecedor 2" class="img-fluid" style="max-width: 200px;">
                </a>
            ...
            <div class="col-md-4 col-sm-6 col-12 text-center mb-4">
                <a href="https://www.fornecedor3.com.br" target="_blank">
                    <img src="../img/Entidades/Logo Fornecedores Emergencia/03.jpg" alt="Fornecedor 3" class="img-fluid" style="max-width: 200px;">
                </a>
            ...
            <div class="col-md-8 col-12">
                <div class="p-4 border rounded bg-light">
                    ...
                    <p class="mt-3">
                        ...
                        <strong>Ramal:</strong> 3456-4700 (Setor de Emergência)<br>
                        <strong>Email:</strong> <a href="mailto:emergencia@hospitalviamao.ficticio">emergencia@hospitalviamao.ficticio</a><br>
